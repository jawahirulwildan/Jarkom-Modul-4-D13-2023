...
#### Aura
```
ip route 10.28.64.0 255.255.255.0 10.28.65.2
ip route 10.28.160.0 255.255.255.224 10.28.192.2
ip route 10.28.136.0 255.255.255.252 10.28.192.2
ip route 10.28.152.0 255.255.255.252 10.28.192.2
ip route 10.28.144.0 255.255.248.0 10.28.192.2
ip route 10.28.132.0 255.255.252.0 10.28.192.2
ip route 10.28.128.8 255.255.255.252 10.28.192.2
ip route 10.28.128.0 255.255.255.248 10.28.192.2
ip route 10.28.24.0 255.255.255.248 10.28.32.2
ip route 10.28.24.8 255.255.255.252 10.28.32.2
ip route 10.28.21.0 255.255.255.252 10.28.32.2
ip route 10.28.16.0 255.255.252.0 10.28.32.2
ip route 10.28.20.0 255.255.255.0 10.28.32.2
ip route 10.28.8.0 255.255.255.252 10.28.32.2
ip route 10.28.2.0 255.255.254.0 10.28.32.2
ip route 10.28.0.64 255.255.255.252 10.28.32.2
ip route 10.28.0.0 255.255.255.192 10.28.32.2
ip route 10.28.4.0 255.255.252.0 10.28.32.2
```

#### Denken
```
ip route 0.0.0.0 0.0.0.0 10.28.65.1
```

#### Frieren
```
ip route 10.28.132.0 255.255.252.0 10.28.136.2
ip route 0.0.0.0 0.0.0.0 10.28.192.1
ip route 10.28.152.0 255.255.255.252 10.28.136.2
ip route 10.28.144.0 255.255.248.0 10.28.136.2
ip route 10.28.128.8 255.255.255.252 10.28.136.2
ip route 10.28.128.0 255.255.255.248 10.28.136.2
```

#### Fern
```
ip route 0.0.0.0 0.0.0.0 10.28.152.1
```

#### Flamme
```
ip route 10.28.128.0 255.255.255.248 10.28.128.10
ip route 10.28.144.0 255.255.248.0 10.28.152.2
ip route 0.0.0.0 0.0.0.0 10.28.136.1
```

#### Himmel
```
ip route 0.0.0.0 0.0.0.0 10.28.128.9
```
#### Eisen
```
ip route 0.0.0.0 0.0.0.0 10.28.32.1
ip route 10.28.16.0 255.255.252.0 10.28.21.2
ip route 10.28.20.0 255.255.255.0 10.28.21.2
ip route 10.28.2.0 255.255.254.0 10.28.8.2
ip route 10.28.0.64 255.255.255.252 10.28.8.2
ip route 10.28.0.0 255.255.255.192 10.28.8.2
ip route 10.28.4.0 255.255.252.0 10.28.8.2
```

#### Linie
```
ip route 0.0.0.0 0.0.0.0 10.28.8.1
ip route 10.28.0.0 255.255.255.192 10.28.0.66
ip route 10.28.4.0 255.255.252.0 10.28.0.66
```

#### Lugner
```
ip route 0.0.0.0 0.0.0.0 10.28.21.1
```

#### Lawine
```
ip route 10.28.4.0 255.255.252.0 10.28.0.3
ip route 0.0.0.0 0.0.0.0 10.28.0.65
```
#### Heiter
```
